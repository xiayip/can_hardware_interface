...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("piper_bringup"), "urdf", "agilex_piper_dual.system.xacro"]
            ),
            " ",
            "use_mock_hardware:=",
            use_mock_hardware,
    ...
    robot_controller_names += ["dual_arm_trajectory_controller"]
    ...
    inactive_robot_controller_names = ["dual_arm_forward_position_controller"]
