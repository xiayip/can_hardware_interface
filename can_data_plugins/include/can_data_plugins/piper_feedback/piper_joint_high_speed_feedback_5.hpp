...
struct PiperJointHighSpeedFeedback5 : public can_data_plugins::CanDataBase
{
    ...
    void export_state_interface(std::vector<hardware_interface::StateInterface> &state_interfaces)
    {
        state_interfaces.emplace_back(
            hardware_interface::StateInterface("joint5", hardware_interface::HW_IF_VELOCITY, &joint_5_actual_velocity));
        state_interfaces.emplace_back(
            hardware_interface::StateInterface("joint5", hardware_interface::HW_IF_EFFORT, &joint_5_actual_effort));
    }
